...
public class Summon extends Skill
{
	...
	public boolean checkCondition(Creature activeChar, Creature target, boolean forceUse, boolean dontMove, boolean first)
	{
		...
		if (player.canOverrideCond(PcCondOverride.SKILL_TARGET_CONDITIONS))
			return true;
	...
	public void useSkill(Creature caster, List<Creature> targets)
	{
		...
		switch(_summonType)
		{
			...
			case SIEGE_SUMMON:
				...
				// Support for pet buffs in nexus.
				if (NexusEvents.isInEvent(activeChar) && activeChar.getEventInfo() != null)
					EventBuffer.getInstance().buffPet(activeChar.getEventInfo());
