...
public final class EffectTransformation extends Effect
{
	...
	public boolean checkCondition()
	{
		...
		{
			_effected.sendMessage("You cannot transform while mounted.");
			return false;
		}
		...
		if (_effected.getPlayer() != null && _effected.getPlayer().isActionBlocked(Zone.BLOCKED_ACTION_TRANSFORMATION))
		{
			_effected.getPlayer().sendMessage("You are not allowed to transform in this zone.");
			return false;
		}
