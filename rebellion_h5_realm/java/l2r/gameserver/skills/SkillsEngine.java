...
public class SkillsEngine
{
	...
	public Map<Integer, Skill> loadAllSkills()
	{
		...
		Map<Integer, Skill> result = new HashMap<Integer, Skill>(66100);
		int maxId = 0, maxLvl = 0;

		if (Config.CUSTOM_SKILLS_LOAD)
			files.addAll(FileUtils.listFiles(Customdir, FileFilterUtils.suffixFileFilter(".xml"), FileFilterUtils.directoryFileFilter()));
