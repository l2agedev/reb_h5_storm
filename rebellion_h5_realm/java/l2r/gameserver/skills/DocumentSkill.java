...
public final class DocumentSkill extends DocumentBase
{
	...
	public class SkillTemplate
	{
		...
		public List<Skill> skills = new ArrayList<Skill>(100);
		public List<Skill> currentSkills = new ArrayList<Skill>(100);
	}

	private SkillTemplate currentSkill;
	private Set<String> usedTables = new HashSet<String>();
	private List<Skill> skillsInFile = new LinkedList<Skill>();
	...
	protected void parseSkill(Node n)
	{
		...
		try
		{
			Map<Integer, Integer> displayLevels = new HashMap<Integer, Integer>(100);
