			...
			switch(val)
			{
				...
				case 2:
					...
					else
					{
						...
						html.replace("%month%", String.valueOf(Olympiad.getPeriod()));
						html.replace("%weekmonth%", String.valueOf(Olympiad.getCurrentCycle()));
						html.replace("%totalNoble%", String.valueOf(Olympiad.getCountOpponents()));
