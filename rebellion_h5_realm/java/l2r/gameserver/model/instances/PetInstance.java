...
public class PetInstance extends Summon
{
	...
	class FeedTask extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			else if(getCurrentFed() <= 0.10 * getMaxFed())
			{
				...
				owner.sendMessage(new CustomMessage("l2r.gameserver.model.instances.L2PetInstance.UnSummonHungryPet", owner));
				unSummon();
				return;
			}
	...
	{
		if (getPlayer() != null && getPlayer().canOverrideCond(PcCondOverride.MAX_STATS_VALUE))
	...
	public void displayReceiveDamageMessage(Creature attacker, int damage)
	{
		...
		if(attacker != this &&!isDead() && owner != null)
		{
