...
public class EffectList
{
	...
	public Effect getEffectBySkillId(int skillid)
	{
		if(isEmpty())
			return null;
	...
	{
	if(e.isHidden() || e.getSkill().isPassive() || e.getSkill().isToggle() || e.getSkill() instanceof Transformation || e.getStackType().equals(EffectTemplate.HP_RECOVER_CAST) || e.getEffectType() == EffectType.Cubic || e.getEffectType() == EffectType.CharmOfCourage)
		...
		/*
			...
			for (String arg : ef2._stackTypes)
				if (ef1._stackTypes.contains(arg))
					return true;
		*/ 
		//TODO: Infern0 this should be more correct... test
