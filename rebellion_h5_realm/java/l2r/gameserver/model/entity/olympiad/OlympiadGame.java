...
public class OlympiadGame
{
	...
	public OlympiadGame(int id, CompType type, List<Integer> opponents)
	{
		...
		Log.olympiad("Olympiad System: Game - " + id + ": " + _team1.getName() + " Vs " + _team2.getName());
	}
	...
	public void managerShout()
	{
		for(NpcInstance npc : Olympiad.getNpcs())
		{
			...
			//Functions.npcShout(npc, npcString, String.valueOf(_id + 1)); // This spam too much...
			Functions.npcSayInRange(npc, 1000, npcString, String.valueOf(_id + 1));
		}
	}
	...
	public void validateWinner(boolean aborted, boolean team1) throws Exception
	{
		...
		if(validated)
		{
			Log.olympiad("Olympiad Result: " + _team1.getName() + " vs " + _team2.getName() + " ... double validate check!!!");
			return;
		}
	...
	public void winGame(OlympiadTeam winnerTeam, OlympiadTeam looseTeam)
	{
			...
			if(looserMember != null && winnerMember != null)
			{
				...
				if (Config.ENABLE_PLAYER_COUNTERS)
				{
					if (winnerMember.getPlayer() != null)
						winnerMember.getPlayer().getCounters().addPoint("_Olympiad_Games_Won");
				}
			}
		}
		...
		Log.olympiad("Olympiad Result: " + winnerTeam.getName() + " vs " + looseTeam.getName() + " ... (" + (int) winnerTeam.getDamage() + " vs " + (int) looseTeam.getDamage() + ") " + winnerTeam.getName() + " win " + pointDiff + " points");
	}
	...
	public void tie()
	{
		...
		Log.olympiad("Olympiad Result: " + _team1.getName() + " vs " + _team2.getName() + " ... tie");
	}
