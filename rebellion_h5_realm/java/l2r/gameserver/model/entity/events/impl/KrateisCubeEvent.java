...
import l2r.gameserver.network.serverpackets.ExPVPMatchCCRecord.PvPMatchRecordAction;
...
public class KrateisCubeEvent extends GlobalEvent
{
	...
	private static final Location RETURN_LOC = new Location(-70293, -71029, -1416);
	...
	public void showRank(Player player)
	{
		...
		player.sendPacket(new ExPVPMatchCCRecord(PvPMatchRecordAction.SHOW_WITH_BUTTON, this));
	}
	...
	public void updatePoints(KrateisCubePlayerObject k)
	{
		...
		final ExPVPMatchCCRecord p = new ExPVPMatchCCRecord(PvPMatchRecordAction.SHOW_WITH_BUTTON, this);
