...
public class RequestGiveNickName extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(activeChar.isLangRus() ? "Неправильное название." : "Incorrect title.");
			return;
		}
		...
		if(member != null)
		{
			...
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.clientpackets.RequestGiveNickName.NotInClan", activeChar));
