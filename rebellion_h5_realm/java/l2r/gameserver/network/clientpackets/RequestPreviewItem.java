...
public class RequestPreviewItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(!activeChar.canOverrideCond(PcCondOverride.ITEM_TRADE_CONDITIONS) && (merchant == null || !isValidMerchant || !activeChar.isInRange(merchant, Creature.INTERACTION_DISTANCE)))
		{
			activeChar.sendActionFailed();
			return;
		}
