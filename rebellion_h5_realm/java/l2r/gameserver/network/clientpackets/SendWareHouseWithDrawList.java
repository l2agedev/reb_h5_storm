...
public class SendWareHouseWithDrawList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage("You cannot withdraw items while having karma.");
			return;
		}
		...
		if(!Config.ALLOW_BBS_WAREHOUSE && (whkeeper == null || !activeChar.isInRange(whkeeper, Creature.INTERACTION_DISTANCE)))
		{
