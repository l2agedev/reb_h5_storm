...
public class RequestFriendAddReply extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (requestor.getFriendList().getList().containsKey(activeChar.getObjectId()))
		{
			request.cancel();
			activeChar.sendPacket(new SystemMessage2(SystemMsg.C1_IS_ALREADY_ON_YOUR_FRIEND_LIST).addName(requestor));
			activeChar.sendActionFailed();
			return;
		}
