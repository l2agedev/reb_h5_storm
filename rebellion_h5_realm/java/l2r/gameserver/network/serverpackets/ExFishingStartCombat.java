...
public class ExFishingStartCombat extends L2GameServerPacket
{
	int _time, _hp;
	LureType _lureType;
	int _deceptiveMode, _mode;
	private int char_obj_id;

	public ExFishingStartCombat(Creature character, int time, int hp, int mode, LureType lureType, int deceptiveMode)
	{
	...
	protected final void writeImpl()
	{
		...
		writeC(_lureType.ordinal()); // 0 = newbie lure, 1 = normal lure, 2 = night lure
