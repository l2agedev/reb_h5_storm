...
public class GMViewCharacterInfo extends L2GameServerPacket
{
	...
	private int _runSpd, _walkSpd, _swimWalkSpd, _swimRunSpd,_flyRunSpd, _flyWalkSpd, DwarvenCraftLevel, running, pledge_class;
	...
	public GMViewCharacterInfo(final Player cha)
	{
		...
		for(int PAPERDOLL_ID : Inventory.PAPERDOLL_ORDER)
		{
			...
			_inv[PAPERDOLL_ID][1] = cha.getInventory().getPaperdollItemDisplayId(PAPERDOLL_ID);
