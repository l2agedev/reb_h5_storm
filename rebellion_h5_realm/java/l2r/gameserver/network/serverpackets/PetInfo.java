...
{
	private int _runSpd, _walkSpd, _swimRunSpd, _swimWalkSpd, _flyRunSpd, _flyWalkSpd, MAtkSpd, PAtkSpd, pvp_flag, karma, rideable;
	...
	public PetInfo(Summon summon)
	{
		...
		_runSpd = (int) (summon.getRunSpeed() / summon.getMovementSpeedMultiplier());
		_walkSpd = (int) (summon.getWalkSpeed() / summon.getMovementSpeedMultiplier());
		_flyRunSpd = (int) (summon.isFlying() ? summon.getRunSpeed() / summon.getMovementSpeedMultiplier() : 0);
		_flyWalkSpd = (int) (summon.isFlying() ? summon.getWalkSpeed() / summon.getMovementSpeedMultiplier() : 0);
		_swimRunSpd = summon.getSwimSpeed();
		_swimWalkSpd = summon.getSwimSpeed();
		...
		_abnormalEffect = summon.getAbnormalEffect(AbnormalEffectType.FIRST);
		_abnormalEffect2 = summon.getAbnormalEffect(AbnormalEffectType.SECOND);
