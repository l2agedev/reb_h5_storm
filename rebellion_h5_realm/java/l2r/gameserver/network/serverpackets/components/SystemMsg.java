...
public enum SystemMsg implements IStaticPacket
{
	...
	// Message: In accordance with company policy, your account has been suspended for submitting a false report. Submitting a false report to the Support Center may harm other players. For more information on account suspension, please visit the Support Center on the NCsoft website (http://us.ncsol2r.com/support).
	...
	// Message: Your account has been suspended for violating the EULA, RoC and/or User Agreement. When a user violates the terms of the User Agreement, the company can impose a restriction on the applicable user's account. For more information on account suspension, please visit the Support Center on the NCsoft website (http://us.ncsol2r.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_VIOLATING_THE_EULA_ROC_ANDOR_USER_AGREEMENT(431),
	// Message: Your account has been suspended for 7 days (retroactive to the day of disclosure), under Chapter 3, Section 14 of the Lineage II Service Use Agreement, for dealing or attempting to deal items or characters (accounts) within the game in exchange for cash or items of other games. Suspension of your account will automatically expire after 7 days. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2r.com/support).
	...
	// Message: Your account has been suspended, under Chapter 3, Section 14 of the Lineage II Service Use Agreement, for dealing or attempting to deal items or characters (accounts) within the game in exchange for cash or items of other games. For more information, please visit the Support Center on the NCsoft website (http://us.ncsol2r.com/support).
	...
	// Message: $s1, to better server our customers, all chat histories are stored and maintained by NCsol2r.  If you do not agree to have your chat records stored, please close the chat window now.  For more information regarding this procedure, please visit our home page at www.PlayNC.com.  Thank you!
	...
	// Message: Your account may have been involved in identity thel2r. As such, it has been temporarily restricted. If this does not apply to you, you may obtain normal service by going through self-identification on the homepage. Please refer to the plaync homepage (www.plaync.co.kr) customer center (Lineage 2) clause 1:1 for more details.
	...
	YOU_HAVE_BEEN_BLOCKED_DUE_TO_VERIFICATION_THAT_YOU_ARE_USING_A_THIRD_PARTY_PROGRAM_SUBSEQUENT(2486), // До сих пор Вы получали штрафы за использование нелегальных программ в соответствии с количеством имеющихся у Вас очков. Со следующего раза штраф будет предусматривать не только игровые штрафы, но и неудобства в использовании аккаунта.
	YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_CONNECTION_HAS_BEEN_ENDED_PLEASE(2487),
