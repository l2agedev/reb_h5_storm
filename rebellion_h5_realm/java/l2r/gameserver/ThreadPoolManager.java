...
import l2r.commons.threading.LoggingRejectedExecutionHandler;
...
public class ThreadPoolManager
{
	...
	public CharSequence getHtmlStats()
	{
		StringBuilder list = new StringBuilder();
		
		list.append("<font color=\"LEVEL\">ScheduledThreadPool</font><br1>");
		list.append("============================<br1>");
		list.append("\tgetActiveCount: ...... ").append(_scheduledExecutor.getActiveCount()).append("<br1>");
		list.append("\tgetCorePoolSize: ..... ").append(_scheduledExecutor.getCorePoolSize()).append("<br1>");
		list.append("\tgetPoolSize: ......... ").append(_scheduledExecutor.getPoolSize()).append("<br1>");
		list.append("\tgetLargestPoolSize: .. ").append(_scheduledExecutor.getLargestPoolSize()).append("<br1>");
		list.append("\tgetMaximumPoolSize: .. ").append(_scheduledExecutor.getMaximumPoolSize()).append("<br1>");
		list.append("\tgetCompletedTaskCount: ").append(_scheduledExecutor.getCompletedTaskCount()).append("<br1>");
		list.append("\tgetQueuedTaskCount: .. ").append(_scheduledExecutor.getQueue().size()).append("<br1>");
		list.append("\tgetTaskCount: ........ ").append(_scheduledExecutor.getTaskCount()).append("<br1>");
		list.append("<font color=\"LEVEL\">ThreadPoolExecutor</font><br1>");
		list.append("============================<br1>");
		list.append("\tgetActiveCount: ...... ").append(_executor.getActiveCount()).append("<br1>");
		list.append("\tgetCorePoolSize: ..... ").append(_executor.getCorePoolSize()).append("<br1>");
		list.append("\tgetPoolSize: ......... ").append(_executor.getPoolSize()).append("<br1>");
		list.append("\tgetLargestPoolSize: .. ").append(_executor.getLargestPoolSize()).append("<br1>");
		list.append("\tgetMaximumPoolSize: .. ").append(_executor.getMaximumPoolSize()).append("<br1>");
		list.append("\tgetCompletedTaskCount: ").append(_executor.getCompletedTaskCount()).append("<br1>");
		list.append("\tgetQueuedTaskCount: .. ").append(_executor.getQueue().size()).append("<br1>");
		list.append("\tgetTaskCount: ........ ").append(_executor.getTaskCount()).append("<br1>");
		list.append("============================<br1>");
		return list;
	}
}
