...
public class AdminQuests implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_quest:
				...
				if(_quest == null)
				{
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message2", activeChar, wordList[1]));
					return true;
				}
	...
	private boolean cmd_Clear(Quest _quest, String[] wordList, Player activeChar)
	{
		...
		if(qs == null)
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message3", activeChar, targetChar.getName(), _quest.getName()));
			return false;
		}
	...
	private boolean cmd_Show(Quest _quest, String[] wordList, Player activeChar)
	{
		...
		if(qs == null)
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message4", activeChar, targetChar.getName(), _quest.getName()));
			return false;
		}
	...
	private boolean cmd_Var(Quest _quest, String[] wordList, Player activeChar)
	{
		...
		if(qs == null)
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message6", activeChar, targetChar.getName(), _quest.getName()));
	...
	private boolean cmd_State(Quest _quest, String[] wordList, Player activeChar)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message9", activeChar, wordList[3]));
			return false;
		}
		...
		if(qs == null)
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message10", activeChar, _quest.getName(), targetChar.getName()));
	...
	private Player getTargetChar(String[] wordList, int wordListIndex, Player activeChar)
	{
		...
		if(wordListIndex >= 0 && wordList.length > wordListIndex)
		{
			...
			if(player == null)
				activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminquests.message11", activeChar, wordList[wordListIndex]));
			return player;
		}
