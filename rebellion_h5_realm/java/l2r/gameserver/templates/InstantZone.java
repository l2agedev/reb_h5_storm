...
public class InstantZone
{
	...
	public static class ZoneInInstanceInfo
	{
		private final ZoneTemplate _template;
		private final boolean _active;

		public ZoneInInstanceInfo(ZoneTemplate template, boolean opened)
		{
			_template = template;
			_active = opened;
		}
	...
	private final Map<String, ZoneInInstanceInfo> _zones;
	...
	private InstantZoneEntryType _entryType = null;

	public InstantZone(int id, int displayId, String name, SchedulingPattern resetReuse, int sharedReuseGroup, int timelimit, boolean dispelBuffs, int minLevel, int maxLevel, int minParty, int maxParty, int timer, boolean onPartyDismiss, List<Location> tele, Location ret, int mapx, int mapy, IntObjectMap<DoorInfo> doors, Map<String, ZoneInInstanceInfo> zones,  Map<String, SpawnInfo2> spawns, List<SpawnInfo> spawnsInfo, int collapseIfEmpty, int maxChannels, int removedItemId, int removedItemCount, boolean removedItemNecessity, int giveItemId, int givedItemCount, int requiredQuestId, boolean setReuseUponEntry, StatsSet params, InstantZoneEntryType entrytype)
	{
		_id = id;
	...
	public Map<String, ZoneInInstanceInfo> getZones()
	{
		return _zones;
	}
