...
public class StatFunctions
{
	private static final int[] ACCURACY_LEVEL_BONUS = { 0,
		...
		118, 120, 122, 125, 128, 130, 132, 135, 137, 139  // 91-100
		};
	...
	private static class FuncPDamageResists extends Func
	{
		...
		public void calc(Env env)
		{
			...
			env.value = Formulas.calcDamageResists(env);
		}
	}
	...
	private static class FuncCAtkLimit extends Func
	{
		...
		{
			if (!env.character.canOverrideCond(PcCondOverride.MAX_STATS_VALUE))
				env.value = Math.min(Config.getLimit(Config.LIMIT_CRIT_DAM, env.character) / 2., env.value);
		}
	}
