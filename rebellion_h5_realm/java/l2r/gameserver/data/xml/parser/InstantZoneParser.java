...
public class InstantZoneParser extends AbstractDirParser<InstantZoneHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			Map<String, ZoneInInstanceInfo> zones = Collections.emptyMap();
			...
			for(Iterator<Element> subIterator = element.elementIterator(); subIterator.hasNext();)
			{
				...
				else if("instanceType".equalsIgnoreCase(subElement.getName()))
				{
					String type = subElement.attributeValue("value");
					if (type.equalsIgnoreCase("SOLO"))
						ize = InstantZoneEntryType.SOLO;
					else if (type.equalsIgnoreCase("PARTY"))
						ize = InstantZoneEntryType.PARTY;
					else if (type.equalsIgnoreCase("CC"))
						ize = InstantZoneEntryType.COMMAND_CHANNEL;
				}
				...
				else if("zones".equalsIgnoreCase(subElement.getName()))
				{
					...
					{
						if(zones.isEmpty())
							zones = new HashMap<String, ZoneInInstanceInfo> ();
						...
						zones.put(template.getName(), new ZoneInInstanceInfo(template, active));
					}
				}
