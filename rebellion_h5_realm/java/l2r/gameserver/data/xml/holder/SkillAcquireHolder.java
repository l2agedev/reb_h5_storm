...
public final class SkillAcquireHolder extends AbstractHolder
{
	...
	private TIntObjectHashMap<List<SkillLearn>> _normalSkillTree = new TIntObjectHashMap<List<SkillLearn>>(57500);
	private TIntObjectHashMap<List<SkillLearn>> _transferSkillTree = new TIntObjectHashMap<List<SkillLearn>>(100);
	// расовые зависимости
	private TIntObjectHashMap<List<SkillLearn>> _fishingSkillTree = new TIntObjectHashMap<List<SkillLearn>>(670);
	private TIntObjectHashMap<List<SkillLearn>> _transformationSkillTree = new TIntObjectHashMap<List<SkillLearn>>(120);
	// без зависимостей
	private List<SkillLearn> _certificationSkillTree = new ArrayList<SkillLearn>(72);
	private List<SkillLearn> _collectionSkillTree = new ArrayList<SkillLearn>();
	private List<SkillLearn> _pledgeSkillTree = new ArrayList<SkillLearn>(45);
	private List<SkillLearn> _subUnitSkillTree = new ArrayList<SkillLearn>(20);
