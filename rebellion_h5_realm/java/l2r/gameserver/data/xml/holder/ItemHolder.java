...
public final class ItemHolder extends AbstractHolder
{
	...
	private final TIntObjectHashMap<ItemTemplate> _items = new TIntObjectHashMap<ItemTemplate>(19200);
	...
	{
		ItemTemplate template = getTemplate(itemId);
		if (template != null)
	...
	public TIntObjectHashMap<ItemTemplate> getAllItems()
	{
		return _items;
	}
