...
public class PetDataTable
{
	...
	public static enum Pet
	{
		...
		private Pet(int npcId, int controlItemId, int foodId, boolean isMountabe, int minLevel, int addFed, double expPenalty, int soulshots, int spiritshots)
		{
			_npcId = npcId;
	...
	{
		int[] items = new int[Pet.values().length];
		int i = 0;
		for(Pet pet : Pet.values())
