...
public final class NaiaTowerManager
{
	...
	private static FastTable<NpcInstance> _spores = new FastTable<NpcInstance>();
	...
	public static void startNaiaTower(Player leader)
	{
		...
		for(Player member : leader.getPlayerGroup())
	...
	private static void addGroupToTower(Player leader)
	{
		...
		_groupList.put(_index, leader.getPlayerGroup().getMembers());
