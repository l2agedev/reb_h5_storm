 ...
 * 
 */
package l2r.gameserver.nexus_engine.events.engine.lang;
...
{
	private static final String DIRECTORY = "config/NexusEngine";
	...
	{
		File folder = Config.getFile(DIRECTORY);
	...
	{
		File dir = Config.getFile(DIRECTORY);
