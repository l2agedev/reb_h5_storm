...
public class EventSQLManager
{
	...
	private static void init()
	{
		...
		{ 
			...
			new GlobalConfigModel("Core", "globalEventManagerId", "9993", "Global Event NPC Manager ID.", 1),
			...
			new GlobalConfigModel("Features", "statTrackingEnabled", "false", "Stats Tracking.", 1),
			...
			new GlobalConfigModel("Features", "allowSiegePlayersToJoin", "false", "Put 'true' to allow players who are inside fort/castle/tw siege to join.", 1),
