...
public class BufferFeature extends AbstractFeature
{
	...
	public BufferFeature(EventType event, PlayerEventInfo gm, String parametersString)
	{
		...
		addConfig("CustomBufferId", "You can specify the ID of buffer (or another NPC which will be available near players during the wait-time) for this mode. Put '0' to disable.", 1);
