...
public class GlobalStats extends EventStats
{
	...
	private enum SortType
	{
		...
		LEVEL("character_subclasses.level DESC"),
		KDRATIO("");
	...
	private void showGlobalStats(PlayerEventInfo player, String params)
	{
		...
		if(sort != null)
		{
			...
			if(text != null)
			{
				...
				if(backToCbMenu)
					text = text.replaceAll("%back%", "<button value=\"Back\" width=60 action=\"bypass -h nxs_showstats_cbmenu\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
				else
				...
				NexusLoader.debug("[ERROR] = showGlobalStats, text is NULL, nothing send...");
		}
	}
	...
	private String addExtraData(String text, String sortType, String page, boolean backToCbMenu)
	{
		if(backToCbMenu)
		{
			text = text.replaceAll("%data%", "<button value=\"Back\" width=60 action=\"bypass -h nxs_showstats_cbmenu\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
		}
		else
		{
			if(sortType != null && page != null)
			{
				...
				text = text.replaceAll("%data%", "<button value=\"Back\" width=60 action=\"bypass -h nxs_showstats_global_topplayers " + pageNumber + " " + sortType.toString() + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
			}
			else
			{
	...
	protected void loadGlobalStats()
	{
		...
		if(_ignoreGMs && _ignoreBannedPlayers)
			condition = "characters.accesslevel = '0'";
		else if(_ignoreGMs)
			condition = "characters.accesslevel <= '0'";
		...
		try
		{
			...
			//for(SortType sortType : SortType.values())
			{
				...
				statement = con.prepareStatement("SELECT characters.char_name, characters.obj_Id, characters.online, characters.pvpkills, characters.pkkills, characters.clanid, character_subclasses.level, character_subclasses.class_id, nexus_stats_global.* FROM nexus_stats_global LEFT JOIN characters ON characters.obj_Id = nexus_stats_global.player LEFT JOIN character_subclasses ON character_subclasses.char_obj_id = nexus_stats_global.player AND character_subclasses.active = '1' WHERE " + condition + " ORDER BY characters.char_name");
				...
				for(SortType sortType : SortType.values())
				{
					...
					sorted = new FastTable<GlobalStatsSum>();
					...
					for(GlobalStatsSum stats : sorted)
					{
						...
						if (count % playersPerPage == 1)
						{
							...
							tb.append("<table width=725><tr><td width=70 align=left><button value=\"Refresh\" width=70 action=\"bypass -h nxs_showstats_global_topplayers " + (((count-1) / playersPerPage) + 1) + " " + sortType.toString() + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td><td width=500 align=center><font color=7f7f7f>(click on column name to sort the players)</font></td><td width=60><font color=ac9887>Name:</font></td><td width=100 align=left><edit var=\"name\" width=100 height=14></td><td width=65 align=right><button value=\"Find\" width=60 action=\"bypass -h nxs_showstats_global_oneplayer $name " + sortType.toString() + " " + (((count - 1) / playersPerPage) + 1) + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table>");
						...
						{
							tb.append("<center><br><br><table width=140><tr><td width=70 align=left>" + ((count - 1) / playersPerPage != 0 ? "<button value=\"Page " + ((count - 1) / playersPerPage) + "\" width=60 action=\"bypass -h nxs_showstats_global_topplayers " + ((count - 1) / playersPerPage) + " " + sortType.toString() + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" : "<font color=ac9887>Page " + (((count - 1) / playersPerPage)+1) + "</font>") + "</td>"
									+ "<td width=70 align=right>" + ((count - 1) / playersPerPage != size / playersPerPage ? "<button value=\"Page " + (((count - 1) / playersPerPage) + 2) + "\" width=60 action=\"bypass -h nxs_showstats_global_topplayers " + (((count - 1) / playersPerPage) + 2) + " " + sortType.toString() + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" : "<font color=ac9887>Page " + (((count - 1) / playersPerPage)+2) + "</font>") + "</td></tr></table>");
					...
					{
						tb.append("<center><br><br><table width=140><tr><td width=70 align=left>" + ((count - 1) / playersPerPage != 0 ? "<button value=\"Page " + ((count - 1) / playersPerPage) + "\" width=60 action=\"bypass -h nxs_showstats_global_topplayers " + ((count - 1) / playersPerPage) + " " + sortType.toString() + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" : "<font color=ac9887>Page " + (((count - 1) / playersPerPage)+1) + "</font>") + "</td>"
								+ "<td width=70 align=right>" + ((count - 1) / playersPerPage != size / playersPerPage ? "<button value=\"Page " + (((count - 1) / playersPerPage) + 2) + "\" width=60 action=\"bypass -h nxs_showstats_global_topplayers " + (((count - 1) / playersPerPage) + 2) + " " + sortType.toString() + "\" height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" : "<font color=ac9887>Page " + (((count - 1) / playersPerPage)+1) + "</font>") + "</td></tr></table>");
