...
public class SepulcherNpcInstance extends NpcInstance
{
	...
	public void showChatWindow(Player player, int val, Object... arg)
	{
		...
		switch(getNpcId())
		{
			...
			case 31466:
			case 31467:
				if(player.isInParty() && !hasPartyAKey(player) && player.getParty().isLeader(player))
				{
					Functions.addItem(player.getParty().getLeader(), HALLS_KEY, 1);
					doDie(player);
				}
				return;
		}
	...
	public void sayInShout(String msg)
	{
		...
		for(Player player : knownPlayers)
		{
			if(player == null)
				continue;
			if(Location.checkIfInRange(15000, player, this, true))
