	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if(command.startsWith("request_1_badge")) //Falk
		{
			...
			try
			{
				...
				{
					player.sendMessage(new CustomMessage("scripts.npc.model.caravantraderinstance.incorrect_count", player));
					return;
				}
		...
		else if(command.startsWith("enter_urban")) // Kanaf - urban area instance
		{
			...
			{
				player.setVar("EnterUrban", 1, -1);
				ReflectionManager.enterReflection(player, 2);
			}
		}
		else
