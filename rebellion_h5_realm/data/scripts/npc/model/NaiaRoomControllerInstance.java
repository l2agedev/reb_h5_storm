	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if(command.startsWith("challengeroom"))
		{
			...
			switch(npcId)
			{
				...
				case 18494:
				{
					ZoneHolder.getDoor(18250001).closeMe();
				...
				case 18495:
				{
					ZoneHolder.getDoor(18250002).closeMe();
					ZoneHolder.getDoor(18250003).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18496:
				{
					ZoneHolder.getDoor(18250004).closeMe();
					ZoneHolder.getDoor(18250005).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18497:
				{
					ZoneHolder.getDoor(18250006).closeMe();
					ZoneHolder.getDoor(18250007).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18498:
				{
					ZoneHolder.getDoor(18250008).closeMe();
					ZoneHolder.getDoor(18250009).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18499:
				{
					ZoneHolder.getDoor(18250010).closeMe();
					ZoneHolder.getDoor(18250011).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18500:
				{
					ZoneHolder.getDoor(18250101).closeMe();
					ZoneHolder.getDoor(18250013).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18501:
				{
					ZoneHolder.getDoor(18250014).closeMe();
					ZoneHolder.getDoor(18250015).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18502:
				{
					ZoneHolder.getDoor(18250102).closeMe();
					ZoneHolder.getDoor(18250017).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18503:
				{
					ZoneHolder.getDoor(18250018).closeMe();
					ZoneHolder.getDoor(18250019).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18504:
				{
					ZoneHolder.getDoor(18250103).closeMe();
					ZoneHolder.getDoor(18250021).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
				...
				case 18505:
				{
					ZoneHolder.getDoor(18250022).closeMe();
					ZoneHolder.getDoor(18250023).closeMe();
					_roomMobList = new ArrayList<NpcInstance>();
