 ...
 */
public class CustomAuctionedManagerInstance extends ManagerInstance
{
	public CustomAuctionedManagerInstance(int objectId, NpcTemplate template)
	{
	...
	{
		Residence residence = getCustomClanHall();
