...
public class AuctionedDoormanInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if(command.equalsIgnoreCase("closeDoors"))
		{
			...
			{
				for(int d : _doors)
					ZoneHolder.getDoor(d).closeMe(player, true);
	...
	public void showChatWindow(Player player, int val, Object... arg)
	{
		...
		if (clanHall != null)
		{
			...
			if (playerClan != null && playerClan.getHasHideout() == clanHall.getId())
				switch (clanHall.getId())
				{
					case 34: // Devastated Castle
					case 36: // The Golden Chamber - aden
					case 37: // The Silver Chamber - aden
					case 38: // The Mithril Chamber - aden
					case 39: // Silver Manor - aden
					case 40: // Gold Manor - aden
					case 41: // The Bronze Chamber - aden
					case 51: // Mont Chamber - rune
					case 52: // Astaire Chamber - rune
					case 53: // Aria Chamber - rune
					case 54: // Yiana Chamber - rune
					case 55: // Roien Chamber - rune
					case 56: // Luna Chamber - rune
					case 57: // Traban Chamber - rune
					case 63: // Wild Beast Reserve
					case 64: // Fortress of the Dead
						showChatWindow(player, "residence2/clanhall/WyvernAgitJanitorHi.htm", "%owner%", playerClan.getName());
						break;
					default:
						showChatWindow(player, "residence2/clanhall/AgitJanitorHi.htm", "%owner%", playerClan.getName());
						break;
				}
			else
			{
