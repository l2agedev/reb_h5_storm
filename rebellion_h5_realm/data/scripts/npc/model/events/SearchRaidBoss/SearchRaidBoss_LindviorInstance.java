...
import events.SearchRaidBoss.SearchRaidBoss_Lindvior;
import l2r.gameserver.model.Creature;
import l2r.gameserver.model.Skill;
import l2r.gameserver.model.instances.MonsterInstance;
import l2r.gameserver.templates.npc.NpcTemplate;

public class SearchRaidBoss_LindviorInstance extends MonsterInstance
{
	public SearchRaidBoss_LindviorInstance(int objectId, NpcTemplate template)
	{
	...
	protected void onDeath(Creature killer)
	{
		...
		if (topdam == null)
			topdam = killer;
		SearchRaidBoss_Lindvior.freeSnowman(topdam);
