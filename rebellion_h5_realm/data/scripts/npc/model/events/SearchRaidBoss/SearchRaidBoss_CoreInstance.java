...
import events.SearchRaidBoss.SearchRaidBoss_Core;
import l2r.gameserver.model.Creature;
import l2r.gameserver.model.Skill;
import l2r.gameserver.model.instances.MonsterInstance;
import l2r.gameserver.templates.npc.NpcTemplate;

public class SearchRaidBoss_CoreInstance extends MonsterInstance
{
	/**
     *
     */
	...
	public SearchRaidBoss_CoreInstance(int objectId, NpcTemplate template)
	{
	...
	protected void onDeath(Creature killer)
	{
		...
		if (topdam == null)
			topdam = killer;
		SearchRaidBoss_Core.freeSnowman(topdam);
