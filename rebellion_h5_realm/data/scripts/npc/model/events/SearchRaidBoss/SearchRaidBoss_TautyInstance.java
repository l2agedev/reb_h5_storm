...
import events.SearchRaidBoss.SearchRaidBoss_Tauty;
import l2r.gameserver.model.Creature;
import l2r.gameserver.model.Skill;
import l2r.gameserver.model.instances.MonsterInstance;
import l2r.gameserver.templates.npc.NpcTemplate;

public class SearchRaidBoss_TautyInstance extends MonsterInstance
{
	/**
     *
     */
	...
	public SearchRaidBoss_TautyInstance(int objectId, NpcTemplate template)
	{
	...
	protected void onDeath(Creature killer)
	{
		...
		if (topdam == null)
			topdam = killer;
		SearchRaidBoss_Tauty.freeSnowman(topdam);
