...
public class BelethProtect implements ScriptFile
{
	...
	public void onLoad()
	{
		...
		Zone zone = ZoneHolder.getZone("[Beleth_Protect]");
	...
	public class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		public void onZoneEnter(Zone zone, Creature cha)
		{
			...
			{
				if (HellboundManager.getHellboundLevel() != 0 && (player.isQuestCompleted("_130_PathToHellbound") || player.isQuestCompleted("_133_ThatsBloodyHot")) && player.getVarInt("EnterHellbound") != 0 && player.getVarInt("return") != 0)
					return;
				
				player.sendMessage(new CustomMessage("scripts.zones.belethprotect.cannotbehere", player));
