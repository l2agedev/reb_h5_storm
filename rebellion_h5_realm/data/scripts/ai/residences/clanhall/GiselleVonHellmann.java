...
public class GiselleVonHellmann extends SiegeGuardMystic
{
	...
	private static final Zone ZONE_1 = ZoneHolder.getZone("lidia_zone1");
	private static final Zone ZONE_2 = ZoneHolder.getZone("lidia_zone2");
	...
	public void onEvtAttacked(Creature attacker, int damage)
	{
		...
		if(Location.calculateDistance(attacker, actor, false) > 300. && Rnd.chance(0.13))
