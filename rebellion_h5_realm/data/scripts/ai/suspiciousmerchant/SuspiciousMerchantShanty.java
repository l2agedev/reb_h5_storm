		...
		if(System.currentTimeMillis() > wait_timeout && (current_point > -1 || Rnd.chance(5)))
		{
			if(!wait)
				switch(current_point)
				{
					...
					case 2:
						...
						switch(Rnd.get(4))
						{
							case 0:
								...
								break;
							case 1:
								Functions.npcSay(actor, "How are you?");
								break;
							case 2:
								Functions.npcSay(actor, "Today the weather is good.");
								break;
							case 3:
					...
					case 12:
						wait_timeout = System.currentTimeMillis() + 15000;
						Functions.npcSay(actor, "Where's the road?");
						wait = true;
						return true;
				}
			else
				switch(current_point)
				{
					...
					case 2:
						...
						break;
					case 12:
						Functions.npcSay(actor, "Where the world is going...");
						break;
				}
