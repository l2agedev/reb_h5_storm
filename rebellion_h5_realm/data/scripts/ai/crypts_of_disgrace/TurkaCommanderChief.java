 ...
 * @author Kolobrodik
 * @date 11:46/19.02.12
 * @description: AI моба Turka Commander in Chief (Ghost) в локации Crypts of Disgrace. (ID 27707) - При спауне зовет на помощь миньенов. - При убийстве с неким шансом появляется Guardian of the Burial Grounds (AI crypts_of_disgrace.GuardoftheGrave)
 */
public class TurkaCommanderChief extends Fighter
{
	...
	protected void onEvtSpawn()
	{
		...
		for (int i = 0; i < MinionCount; i++)
			// При спауне главного спауним и миньенов
