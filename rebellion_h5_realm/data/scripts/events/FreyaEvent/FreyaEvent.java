...
public class FreyaEvent extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	public void startEvent()
	{
		...
		if(SetActive(_name, true))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.FreyaEvent.EventStarted", player, _name));
		_active = true;
	...
	public void stopEvent()
	{
		...
		if(SetActive(_name, false))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.FreyaEvent.EventStoped", player, _name));
