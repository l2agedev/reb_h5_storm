...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Goddard городе - ВНИМАНИЕ: ни в коем случае не должно произойти так что бы ID гвардов и статуй совпадали с ID других городов - ВНИМАНИЕ: не ставить ID статуй/гвардов которые участвуют стандартно в спавне (гремленов сменить тоже)
 */
public class GoddardCataclizm extends Cataclizm
{
	...
	private static Zone _zone1 = ZoneHolder.getZone("[godad_peace1]");
	...
	public void onLoad()
	{
		...
		_log.info("Loaded Event: Cataclizm Goddard");
	}
	...
	private static class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		public void onZoneEnter(Zone zone, Creature cha)
		{
			...
			if (_cycle)
				player.sendPacket(new ExShowScreenMessage(NpcString.NONE, 5000, ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER, false, "Город Годдард захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!"));
		}
