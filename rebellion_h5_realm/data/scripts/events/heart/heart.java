...
public class heart extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	public void startEvent()
	{
		...
		if(SetActive("heart", true))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.ChangeofHeart.eventstart", player));
	...
	public void stopEvent()
	{
		...
		if(SetActive("heart", false))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.ChangeofHeart.eventstop", player));
