...
public class MelonSeed extends ScriptItemHandler implements ScriptFile
{
	...
	public boolean useItem(Playable playable, ItemInstance item, boolean ctrl)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("scripts.events.SummerMelons.CannotCultivatAtStadium", activeChar));
			return false;
		}
		if(!activeChar.getReflection().isDefault())
		{
			activeChar.sendMessage(new CustomMessage("scripts.events.SummerMelons.CannotCultivateInInstance", activeChar));
			return false;
		}
		...
		((MelonInstance) npc).setSpawner(activeChar);
