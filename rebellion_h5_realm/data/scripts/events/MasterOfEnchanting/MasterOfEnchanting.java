...
public class MasterOfEnchanting extends Functions implements ScriptFile, OnPlayerEnterListener
{
	...
	public void startEvent()
	{
		...
		if(SetActive(EVENT_NAME, true))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.MasOfEnch.eventstart", player));
	...
	public void stopEvent()
	{
		...
		if(SetActive(EVENT_NAME, false))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.MasOfEnch.eventstop", player));
