...
public class TheFlowOfTheHorror extends Functions implements ScriptFile
{
	...
	public void startEvent()
	{
		...
		if(!isActive())
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.theflowofthehonor.eventstart", player));
	...
	public void stopEvent()
	{
		...
		if(isActive())
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.theflowofthehonor.eventstop", player));
