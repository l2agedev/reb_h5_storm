...
public class TrickOfTrans extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	public void startEvent()
	{
		...
		if(SetActive("trickoftrans", true))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.TrickOfTrans.eventstart", player));
	...
	public void stopEvent()
	{
		...
		if(SetActive("trickoftrans", false))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.TrickOfTrans.eventstop", player));
	...
	private void spawnEventManagers()
	{
		...
		final int CHESTS[][] = { { 148081, 28614, -2274, 2059 }, // Aden
				...
				{ 82424, 147560, -3494, 61567 }, // Giran
				{ 82584, 147560, -3494, 61567 }, // Giran
				{ 82504, 147640, -3494, 61567 }, // Giran
	...
	{
		if(_active && SimpleCheckDrop(cha, killer) && Rnd.chance(Config.EVENT_TRICK_OF_TRANS_CHANCE))
