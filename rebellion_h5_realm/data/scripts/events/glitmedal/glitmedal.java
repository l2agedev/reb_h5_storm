...
public class glitmedal extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	public void startEvent()
	{
		...
		if(SetActive("glitter", true))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.glitmedal.EventStarted", player));
	...
	public void stopEvent()
	{
		...
		if(SetActive("glitter", false))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.glitmedal.EventStoped", player));
