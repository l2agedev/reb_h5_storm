...
public class SavingSnowman extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	public void startEvent()
	{
		...
		if(Boolean.FALSE)
		{
			player.sendMessage(new CustomMessage("scripts.events.SavingSnowman.event_disabled", player));
			return;
		}
		...
		if(SetActive("SavingSnowman", true))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.SavingSnowman.eventstart", player));
	...
	public void stopEvent()
	{
		...
		if(SetActive("SavingSnowman", false))
		{
			...
			player.sendMessage(new CustomMessage("scripts.events.SavingSnowman.eventstop", player));
		_active = false;
	...
	public static void removeRewarder(NpcInstance rewarder)
	{
		...
		double radian = Location.convertHeadingToRadian(rewarder.getHeading());
