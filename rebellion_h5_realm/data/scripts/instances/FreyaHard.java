...
public class FreyaHard extends Reflection
{
	...
	private class FirstStage extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			firstStageGuardSpawn = ThreadPoolManager.getInstance().scheduleAtFixedRate(new GuardSpawnTask(3), 2000L, 60000L);
		}
	}
	...
	private class SecondStage extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			secondStageGuardSpawn = ThreadPoolManager.getInstance().scheduleAtFixedRate(new GuardSpawnTask(4), 2000L, 160000L);
	...
	private class ThirdStage extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			thirdStageGuardSpawn = ThreadPoolManager.getInstance().scheduleAtFixedRate(new GuardSpawnTask(4), 2000L, 100000L);
