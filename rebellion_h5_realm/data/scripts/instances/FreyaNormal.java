...
public class FreyaNormal extends Reflection
{
	...
	private class FirstStage extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			firstStageGuardSpawn = ThreadPoolManager.getInstance().scheduleAtFixedRate(new GuardSpawnTask(1), 2000L, 60000L);
		}
	}
	...
	private class SecondStage extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			secondStageGuardSpawn = ThreadPoolManager.getInstance().scheduleAtFixedRate(new GuardSpawnTask(2), 2000L, 120000L);
	...
	private class ThirdStage extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			thirdStageGuardSpawn = ThreadPoolManager.getInstance().scheduleAtFixedRate(new GuardSpawnTask(3), 2000L, 100000L);
