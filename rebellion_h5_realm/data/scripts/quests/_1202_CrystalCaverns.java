...
public class _1202_CrystalCaverns extends Quest implements ScriptFile
{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == KECHI)
		{
			...
			ref.startCollapseTimer(60 * 1000);
			for (Player plr : ref.getPlayers())
				//TODO: sendMessageS does not have CustomMessage support.
				plr.sendMessageS("Instance will be droped in 1 minute, speak with the NPC to continue...", 5);
				//plr.sendMessageS(new CustomMessage("scripts.quests._1202_CrystalCaverns.dropinstance", plr), 5);
	...
	private void enterInstance(Player player, int type)
	{
		...
		{
			Reflection ref = ReflectionManager.enterReflection(player, INCSTANCED_ZONE_ID);
