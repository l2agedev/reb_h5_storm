...
public class ibkookaburra extends Functions
{
	...
	private static final int BABY_KOOKABURRA_OCARINA = Pet.BABY_KOOKABURRA.getControlItemId();
	private static final int IN_KOOKABURRA_OCARINA = Pet.IMPROVED_BABY_KOOKABURRA.getControlItemId();
	...
	public void evolve()
	{
		...
		control.setEnchantLevel(Pet.IMPROVED_BABY_KOOKABURRA.getMinLevel());
