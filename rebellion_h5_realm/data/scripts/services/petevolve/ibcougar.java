...
public class ibcougar extends Functions
{
	...
	private static final int BABY_COUGAR_CHIME = Pet.BABY_COUGAR.getControlItemId();
	private static final int IN_COUGAR_CHIME = Pet.IMPROVED_BABY_COUGAR.getControlItemId();
	...
	public void evolve()
	{
		...
		control.setEnchantLevel(Pet.IMPROVED_BABY_COUGAR.getMinLevel());
