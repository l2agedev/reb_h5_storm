...
public class wolfevolve extends Functions
{
	...
	private static final int WOLF_COLLAR = Pet.WOLF.getControlItemId(); // Ошейник Wolf
	private static final int GREAT_WOLF_NECKLACE = Pet.GREAT_WOLF.getControlItemId(); // Ожерелье Great Wolf
	...
	public void evolve()
	{
		...
		control.setEnchantLevel(Pet.GREAT_WOLF.getMinLevel());
