...
public class clanhall extends Functions
{
	...
	private static final int WIND_STRIDER_ITEM = Pet.STRIDER_WIND.getControlItemId();
	private static final int STAR_STRIDER_ITEM = Pet.STRIDER_STAR.getControlItemId();
	private static final int TWILING_STRIDER_ITEM = Pet.STRIDER_TWILIGHT.getControlItemId();

	// -- Second Item ID --
	private static final int WHITE_WOLF_NECKLACE = Pet.WGREAT_WOLF.getControlItemId();
	private static final int WHITE_FENRIR_NECKLACE = Pet.WFENRIR_WOLF.getControlItemId();
	private static final int RED_WS_ITEM = Pet.RED_STRIDER_WIND.getControlItemId();
	private static final int RED_SS_ITEM = Pet.RED_STRIDER_STAR.getControlItemId();
	private static final int RED_TW_ITEM = Pet.RED_STRIDER_TWILIGHT.getControlItemId();
