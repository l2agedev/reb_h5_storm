...
public class TeleToGH extends Functions implements ScriptFile
{
	...
	private static Zone _zone = ZoneHolder.getZone("[giran_harbor_offshore]");
	...
	public void onLoad()
	{
		...
		Zone zone = ZoneHolder.getZone("[giran_harbor_peace_alt]");
		zone.setReflection(ReflectionManager.GIRAN_HARBOR);
		zone.setActive(true);
		zone = ZoneHolder.getZone("[giran_harbor_no_trade]");
		zone.setReflection(ReflectionManager.GIRAN_HARBOR);
		zone.setActive(true);
	}
	...
	public void toGH()
	{
		...
		player.teleToLocation(_zone.getSpawn().setR(ReflectionManager.GIRAN_HARBOR).findPointToStay(30, 200), ReflectionManager.GIRAN_HARBOR);
	}
