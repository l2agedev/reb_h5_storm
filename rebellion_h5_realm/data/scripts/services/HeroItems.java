...
import static l2r.gameserver.model.entity.olympiad.Olympiad.OLYMPIAD_HTML_PATH;
...
public class HeroItems extends Functions
{
	...
	public void rendershop(String[] val)
	{
		...
		{
			if(val[0].equalsIgnoreCase("deleteweapon"))
			{
				for(String heroItem[] : HERO_ITEMS)
				{
					...
					{
						ItemFunctions.removeItem(player, itemId, 1, true);
						break;
					}
				}
				return;
