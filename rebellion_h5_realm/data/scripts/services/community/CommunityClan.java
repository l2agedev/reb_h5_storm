...
import l2r.gameserver.model.pledge.Clan.SinglePetition;
...
public class CommunityClan extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		else if ("announcepledgewriteform".equals(cmd))
		{
			...
			{
				_log.error("While selecting clan_notice:", e);
			}
			finally
			{
		...
		else if ("announcepledgeswitchshowflag".equals(cmd))
		{
			...
			{
				con = DatabaseFactory.getInstance().getConnection();
				statement = con.prepareStatement("UPDATE `clan_notice` SET type = ? WHERE `clan_id` = ? and type = ?");
			...
			{
				_log.error("While updating clan_notice:", e);
			}
			finally
			{
	...
	private String getMainClanPage(Player player, Clan clan, String html)
	{
		...
		html = html.replace("%raidsKilled%", String.valueOf(0));// TODO
		html = html.replace("%epicsKilled%", String.valueOf(0));// TODO
		...
		html = html.replace("%nobleCount%", String.valueOf(data[3]));
		html = html.replace("%heroCount%", String.valueOf(data[4]));
		
		StringBuilder builder = new StringBuilder();
		
		if (clan.getAlliance() != null)
		{
			builder.append("<table width=300><tr>");
			for (Clan memberClan : clan.getAlliance().getMembers())
			{
				builder.append("<td>");
				builder.append("<button action=\"bypass _clbbslist_0\" value=\"").append(memberClan.getName()).append("\" width=100 height=31 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\">");
				builder.append("</td>");
			}
			builder.append("</tr></table>");
		}
		html = html.replace("%alliances%", builder.toString());
		
		// Clearing StringBuilder for next use
		...
		for (Clan warClan : clan.getEnemyClans())
		{
			...
			builder.append("<button action=\"bypass _clbbsclan_").append(warClan.getClanId()).append("\" value=\"").append(warClan.getName()).append("\" width=100 height=22 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\">");
		...
		{
			builder.append("<tr><td width=200 align=\"right\">");
			builder.append("<button action=\"bypass _bbsclanjoin_").append(clan.getClanId()).append("_0\" value=\"Join" + " Clan\" width=200 height=30 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_ct1" + ".OlympiadWnd_DF_Apply\">");
			builder.append("</td></tr>");
		}
		html = html.replace("%joinClan%", builder.toString());
		
		StringBuilder recruitmentBuilder = new StringBuilder();
		StringBuilder petitionsBuilder = new StringBuilder();
		...
		{
			recruitmentBuilder.append("<tr><td width=200 align=\"right\">");
			recruitmentBuilder.append("<button action=\"bypass _clbbsmanage_0\" value=\"Manage Recruitment\" width=200 height=30 back=\"L2UI_CT1.OlympiadWnd_DF_Watch_Down\" fore=\"L2UI_ct1.OlympiadWnd_DF_Watch\">");
			recruitmentBuilder.append("</td></tr>");
			
			petitionsBuilder.append("<tr><td width=200 align=\"right\">");
			petitionsBuilder.append("<button action=\"bypass _clbbspetitions_").append(clan.getClanId()).append("\" " + "value=\"Manage Petitions\" width=200 height=30 back=\"L2UI_CT1.OlympiadWnd_DF_HeroConfirm_Down\" " + "fore=\"L2UI_ct1.OlympiadWnd_DF_HeroConfirm\">");
			petitionsBuilder.append("</td></tr>");
			
			noticeBuilder.append("<tr><td width=200 align=\"right\">");
			noticeBuilder.append("<button action=\"bypass _announcepledgewriteform\" value=\"Manage Notice\" width=200 height=30 back=\"L2UI_CT1.OlympiadWnd_DF_Info_Down\" fore=\"L2UI_ct1.OlympiadWnd_DF_Info\">");
			noticeBuilder.append("</td></tr>");
		}
		
		html = html.replace("%manageRecruitment%", recruitmentBuilder.toString());
		html = html.replace("%managePetitions%", petitionsBuilder.toString());
		html = html.replace("%manageNotice%", noticeBuilder.toString());
	...
	private String getClanMembersPage(Player player, Clan clan, String html, int page)
	{
		...
		for (int i = MEMBERS_PER_PAGE * page; i < max; i++)
		{
			...
			builder.append("</td>");
			builder.append("<td width=100><center>").append(member.getPlayer() != null ? "<font color=6a9b54>True</font>" : "<font color=9b5454>False</font>").append("</center></td>");
			
			builder.append("<td width=100><font color=\"bc7420\"><center>").append(member.isSubLeader() != 0 || member.isClanLeader() ? "True" : "False").append("</center></font></td>");
		...
		if (page > 0)
			builder.append("<center><button action=\"bypass _bbsclanmembers_").append(clan.getClanId()).append("_").append(page - 1).append("\" value=\"Previous\" width=140 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.button_df\"></center>");
	...
	private String getClanSingleMemberPage(Player member, String html)
	{
		...
		for (SubClass sub : classes)
		{
			...
			html = html.replace("%" + replacement + "%", getFullClassName(member, ClassId.values()[sub.getClassId()]) + "(" + sub.getLevel() + ")");
		}
	...
	private String getClanSingleMemberPage(Player player, int playerId, String html)
	{
		...
		html = html.replace("%leader%", boolToString(data.isClanLeader));
		html = html.replace("%subpledge%", getUnitName(data.pledge_type));
		html = html.replace("%nobless%", boolToString(data.isNoble));
		html = html.replace("%hero%", boolToString(data.isHero));
		...
		{
			if (sub[2] == 1)
				html = html.replace("%mainClass%", getFullClassName(player, ClassId.values()[sub[0]]) + "(" + sub[1] + ")");
			else
				html = html.replace(otherSubs[index], getFullClassName(player, ClassId.values()[sub[0]]) + "(" + sub[1] + ")");
		}
	...
	private String getClanSinglePetitionPage(Player leader, int playerId, String html)
	{
		...
		{
			if (sub[2] == 1)
				html = html.replace("%mainClass%", getFullClassName(leader, ClassId.values()[sub[0]]) + "(" + sub[1] + ")");
			else
				html = html.replace(otherSubs[index], getFullClassName(leader, ClassId.values()[sub[0]]) + "(" + sub[1] + ")");
		}
		// In case player doesn't have all subclasses
		for (String sub : otherSubs)
			html = html.replace(sub, "<br>");
	...
	private String getClanJoinPage(Player player, Clan clan, String html)
	{
		...
		for (int classNeeded : clan.getClassesNeeded())
		{
			...
			builder.append(getFullClassName(player, ClassId.values()[classNeeded]));
	...
	private String getClanPetitionsPage(Player player, Clan clan, String html)
	{
		...
		for (SinglePetition petition : clan.getPetitions())
		{
			...
			builder.append(boolToString(data.isNoble));
	...
	private int[] getMainClanPageData(Clan clan)
	{
		...
		try
		{
			...
			try
			{
				statement = con.prepareStatement("select count(`characters`.`obj_Id`) from `characters` join `olympiad_nobles` ON `characters`.`obj_Id` = `olympiad_nobles`.`char_id` where `characters`.`clanid` = '" + clan.getClanId() + "'");
				rset = statement.executeQuery();
			...
			try
			{
				statement = con.prepareStatement("select count(`characters`.`obj_Id`) from `characters` join `heroes` on `characters`.`obj_Id` = `heroes`.`char_id` where `characters`.`clanid` = '" + clan.getClanId() + "'");
				rset = statement.executeQuery();
				
				if (rset.next())
				{
					data[4] = rset.getInt("count(`characters`.`obj_Id`)");
				}
			}
			finally
			{
	...
	private String getAllClansRank(Player player, int page)
	{
		...
		// Making first row
		StringBuilder builder = new StringBuilder();
		builder.append("<table width=760><tr><td height=30>");
		builder.append("<table width=760 bgcolor=" + getMainStatsTableColor(0) + " height=30>");
		builder.append("<tr><td width=50>");
		builder.append("<font name=\"hs12\" color=\"b32c25\">Rank</font>");
		builder.append("</td><td width=220>");
		builder.append("<center><font name=\"hs12\" color=\"b32c25\">Clan</font></center>");
		builder.append("</td><td width=110>");
		builder.append("<center><font name=\"hs12\" color=\"b32c25\">Leader</font></center>");
		builder.append("</td><td width=110>");
		builder.append("<center><font name=\"hs12\" color=\"b32c25\">Alliance</font></center>");
		builder.append("</td><td width=60>");
		builder.append("<center><font name=\"hs12\" color=\"b32c25\">Level</font></center>");
		builder.append("</td><td width=210>");
		builder.append("<center><font name=\"hs12\" color=\"b32c25\">Recruitment</font></center>");
		builder.append("</td></tr></table></td></tr>");
		...
		{
			Clan clan = clans[i];
			builder.append("<tr><td height=30>");
			builder.append("<table width=760 bgcolor=\"").append(getMainStatsTableColor(index + 1)).append("\" height=30>");
			builder.append("<tr><td width=50>");
			builder.append("<font name=\"hs12\" color=bc7420>#").append(i + 1).append("</font></center>");
			builder.append("</td><td width=220>");
			builder.append("<center><button action=\"bypass _clbbsclan_").append(clan.getClanId()).append("\" value=\"").append(clan.getName()).append("\" width=200 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_Reward_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Reward\"></center>");
			builder.append("</td><td width=110>");
			builder.append("<center><font color=\"f1b45d\">").append(clan.getLeaderName()).append("</font></center>");
			builder.append("</td><td width=110>");
			builder.append("<center><font color=\"f1b45d\">").append(clan.getAlliance() != null ? clan.getAlliance().getAllyName() : "").append("</font>");
			builder.append("</td><td width=60>");
			builder.append("<center><font color=\"f1b45d\">").append(clan.getLevel()).append("</font></center>");
			builder.append("</td><td width=210>");
			if (!clan.isRecruting() || clan.isFull())
				builder.append("<center><button action=\"bypass _clbbslist_").append(page).append("\" value=\"Recrutation Closed\" width=200 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Apply\"></center>");
			else if (player.getClan() != null)
				builder.append("<center><button action=\"bypass _clbbslist_").append(page).append("\" value=\"Recrutation Opened\" width=200 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Apply\"></center>");
			else
				builder.append("<center><button action=\"bypass _bbsclanjoin_").append(clan.getClanId()).append("_0\" value=\"Join Clan\" width=200 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Apply\"></center>");
	...
	{
		_clanSkillDecriptions.put(370, new String[]
		{
		...
		_clanSkillDecriptions.put(371, new String[]
		{
		...
		_clanSkillDecriptions.put(372, new String[]
		{
		...
		_clanSkillDecriptions.put(373, new String[]
		{
		...
		_clanSkillDecriptions.put(374, new String[]
		{
		...
		_clanSkillDecriptions.put(375, new String[]
		{
		...
		_clanSkillDecriptions.put(376, new String[]
		{
		...
		_clanSkillDecriptions.put(377, new String[]
		{
		...
		_clanSkillDecriptions.put(378, new String[]
		{
		...
		_clanSkillDecriptions.put(379, new String[]
		{
		...
		_clanSkillDecriptions.put(380, new String[]
		{
		...
		_clanSkillDecriptions.put(381, new String[]
		{
		...
		_clanSkillDecriptions.put(382, new String[]
		{
		...
		_clanSkillDecriptions.put(383, new String[]
		{
		...
		_clanSkillDecriptions.put(384, new String[]
		{
		...
		_clanSkillDecriptions.put(385, new String[]
		{
		...
		_clanSkillDecriptions.put(386, new String[]
		{
		...
		_clanSkillDecriptions.put(387, new String[]
		{
		...
		_clanSkillDecriptions.put(388, new String[]
		{
		...
		_clanSkillDecriptions.put(389, new String[]
		{
		...
		_clanSkillDecriptions.put(390, new String[]
		{
		...
		_clanSkillDecriptions.put(611, new String[]
		{
		...
		_clanSkillDecriptions.put(612, new String[]
		{
		...
		_clanSkillDecriptions.put(613, new String[]
		{
		...
		_clanSkillDecriptions.put(614, new String[]
		{
		...
		_clanSkillDecriptions.put(615, new String[]
		{
		...
		_clanSkillDecriptions.put(616, new String[]
		{
		...
		_clanSkillDecriptions.put(848, new String[]
		{
			"STR+1 / INT+1"
		});
		_clanSkillDecriptions.put(849, new String[]
		{
			"DEX+1 / WIT+1"
		});
		_clanSkillDecriptions.put(850, new String[]
		{
			"STR+1 / MEN+1"
		});
		_clanSkillDecriptions.put(851, new String[]
		{
			"CON+1 / MEN+1"
		});
		_clanSkillDecriptions.put(852, new String[]
		{
			"DEX+1 / MEN+1"
		});
		_clanSkillDecriptions.put(853, new String[]
		{
			"CON+1 / INT+1"
		});
		_clanSkillDecriptions.put(854, new String[]
		{
			"DEX+1 / INT+1"
		});
		_clanSkillDecriptions.put(855, new String[]
		{
			"STR+1 / WIT+1"
		});
		_clanSkillDecriptions.put(856, new String[]
		{
			"CON+1 / WIT+1"
		});
	}
