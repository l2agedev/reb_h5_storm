<font color="919191">Contains</font> %count% <font color="919191">banned HWIDs</font>
<table width=275>
    <tr>
        <td><edit var="srch" width=220 height=14></td>
        <td><button value="search" action="bypass -h admin_sg_bans $srch" width=40 height=19 back="L2UI_ch3.smallbutton2" fore="L2UI_ch3.smallbutton2"></td>
    </tr>
</table>
<br>
<center>
